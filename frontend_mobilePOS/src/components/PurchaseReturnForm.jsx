...
export default function PurchaseReturnForm({ onClose, onSave, editData }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6 bg-[#f8fbff] rounded-lg p-4 border border-[#b6e0fe] shadow space-y-2 animate-fadein">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        <input name="returnNo" type="text" placeholder="Return No" value={form.returnNo} onChange={handleChange} required className="input" />
        ...
        <input name="reason" type="text" placeholder="Reason" value={form.reason} onChange={handleChange} required className="input" />
